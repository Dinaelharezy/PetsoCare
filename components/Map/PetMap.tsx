...
import { usePetMap } from './hooks/usePetMap'
    ...
    <div style={{ minHeight: '100vh', padding: '2rem 0' }}>
      <div className="container">
        <MapFilters
          ...
          onPickLocation={allowPinDrop || onSelectLocation ? () => setShowLocModal(true) : undefined}
        />
