...
// import { Shelter } from '../../types/Shelter'
// import { getShelterTypeColor } from '../../utils/shelterDisplay'
...
// export default function ShelterProfileView({ shelter, onBack }: Props) {
//   return (
//     <Container className="py-5">
//       <Card className="p-5 mb-4" style={{ boxShadow: '0 4px 15px rgba(0,0,0,0.08)', borderRadius: '15px', border: 'none' }}>
//         <Row>
//           <Col md={2}>
//             <div style={{ width: '100%', height: '160px', borderRadius: '12px', background: '#f8f9fa', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
//               <i className="bi bi-house-heart text-secondary" style={{ fontSize: '3rem' }} />
//             </div>
//           </Col>
...
//                 <h2 className="mb-1">{shelter.name}</h2>
//                 <p className="text-muted mb-1">{shelter.governorate}</p>
//                 <p className={`mb-0 fw-semibold ${getShelterTypeColor(shelter.animalType)}`}>
//                   {shelter.animalType || 'Not specified'}
//                 </p>
//               </div>
...
//             <div className="d-flex flex-wrap gap-3 text-muted">
//               {shelter.phone && <span><i className="bi bi-telephone me-1"></i>{shelter.phone}</span>}
//               {shelter.address && <span><i className="bi bi-map me-1"></i>{shelter.address}</span>}
//               {shelter.workingHours && <span><i className="bi bi-clock me-1"></i>{shelter.workingHours}</span>}
//             </div>
//           </Col>
//         </Row>
//       </Card>

//       <Card className="p-4" style={{ boxShadow: '0 4px 15px rgba(0,0,0,0.08)', borderRadius: '15px', border: 'none' }}>
//         <h5 className="mb-3">Additional Information</h5>
...
//             <p className="text-muted mb-1">Status</p>
//             <p>
//               <span className={`me-2 ${shelter.workingHours ? 'text-success' : 'text-warning'}`}>●</span>
//               {shelter.workingHours ? 'Operational' : 'Under Construction'}
//             </p>
//           </Col>
...
//           {shelter.notes && (
//             <Col md={12}>
//               <div className="p-3 bg-light rounded" style={{ border: '1px solid #eee' }}>
//                 <p className="mb-1 fw-semibold">Notes</p>
//                 <p className="mb-0 text-muted">{shelter.notes}</p>
//               </div>
//             </Col>
