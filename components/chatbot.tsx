...
//         id: (Date.now() + 1).toString(),
//         text: '🐾 I\'m having trouble connecting right now. Please try again in a moment. If this persists, please contact support.',
//         sender: 'bot',
//         timestamp: new Date(),
//       }
...
//   // Quick reply buttons
//   const quickReplies = [
//     { text: '💉 Rabies vaccine info', query: 'Tell me about rabies vaccination for dogs' },
//     { text: '🏥 Find a vet near me', query: 'How do I find a veterinarian near me?' },
//     { text: '🚨 Emergency symptoms', query: 'What are emergency symptoms in pets?' },
//     { text: '📅 Set a reminder', query: 'How do I set a vaccine reminder?' },
//   ]
...
//           height: '60px',
//           borderRadius: '50%',
//           backgroundColor: 'rgb(173, 241, 120)',
//           border: 'none',
//           cursor: 'pointer',
//           display: 'flex',
//           alignItems: 'center',
...
//             zIndex: 999,
//             overflow: 'hidden',
//             border: `1px solid rgba(173, 241, 120, 0.3)`,
//           }}
//         >
//           {/* Header */}
//           <div
...
//             </div>
//             <div style={{ flex: 1 }}>
//               <h6 style={{ margin: 0, fontWeight: 'bold', color: '#1a3a00', fontSize: '16px' }}>
//                 PetCare AI Assistant
//               </h6>
//               <p style={{ margin: 0, fontSize: '11px', color: '#2d5a00' }}>
...
//                     backgroundColor: message.sender === 'user' ? 'rgb(173, 241, 120)' : 'white',
//                     color: message.sender === 'user' ? '#1a3a00' : '#333',
...
//                       fontSize: '10px',
//                       marginTop: '6px',
//                       color: message.sender === 'user' ? '#4a6a00' : '#999',
//                       textAlign: 'right',
//                     }}
//                   >
...
//                   style={{
//                     background: '#f0fce0',
//                     border: '1px solid rgba(173, 241, 120, 0.5)',
//                     borderRadius: '20px',
//                     padding: '6px 12px',
//                     fontSize: '12px',
//                     cursor: 'pointer',
...
//                   }}
//                   onMouseEnter={(e) => {
//                     e.currentTarget.style.background = 'rgb(173, 241, 120)'
//                   }}
//                   onMouseLeave={(e) => {
//                     e.currentTarget.style.background = '#f0fce0'
//                   }}
//                 >
//                   {reply.text}
//                 </button>
...
//               }}
//               onFocus={(e) => {
//                 e.currentTarget.style.borderColor = 'rgb(173, 241, 120)'
//               }}
//               onBlur={(e) => {
...
//             >
//               {isTyping ? (
//                 <Spinner animation="border" size="sm" style={{ color: '#1a3a00' }} />
//               ) : (
//                 <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1a3a00" strokeWidth="2">
