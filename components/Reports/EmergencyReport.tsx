...
//                 label={action}
//                 className="mb-2"
//                 checked={INITIAL_ACTIONS.includes(action)}
      ...
      <Card className="p-4">
        <Form onSubmit={handleSubmit}>
          ...
          {locationMode === 'manual' && (
            <Form.Group className="mb-4">
              <Form.Label>City / Area <span className="text-danger">*</span></Form.Label>
              <Form.Control type="text" name="locationCity" value={formData.locationCity} onChange={handleChange} placeholder="e.g. Al-Israa Area" required />
            </Form.Group>
          )}
          {locationMode === 'gps' && (
