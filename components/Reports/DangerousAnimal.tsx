...
//             Select the symptoms you observed (multiple selections allowed)
//           </p>
...
//                 onChange={() => {
//                   if (formData.otherSymptom) {
//                     setFormData(prev => ({ ...prev, otherSymptom: '' }))
//                   }
//                 }}
//               />
...
//               🚨 <strong>High Suspicion Case</strong> – Multiple symptoms detected.
//               Please report immediately to the relevant authorities.
//             </Alert>
//           )}
