...
//   // ✅ GET /api/user/profile — اشحن البيانات أول ما الـ session تتوفر
//   useEffect(() => {
//     if (!token) return
...
//   // ✅ PUT /api/user/profile — حفظ الاسم والتليفون
...
//   // ✅ POST /api/user/upload-image — رفع الصورة
...
//         method: 'POST',
//         headers: getHeaders(token), // بدون Content-Type مع FormData
//         body: formData,
//       })

//       if (!res.ok) throw new Error(await res.text())
//       setSuccessMsg('Image uploaded successfully!')
//       await update() // حدّث الـ session
//     } catch (e: any) {
