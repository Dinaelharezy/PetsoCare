...
//             <div 
//               key={vaccine.id} 
//               className="vaccine-item d-flex justify-content-between align-items-center my-2"
...
//                     }}>
//                       {vaccine.victimType === 'Human' ? '🧑' : '🐾'} {vaccine.victimType}
//                     </span>
//                   )}
//                   {vaccine.animalType && (
//                     <span style={{
...
//                     }}>
//                       {vaccine.animalType === 'Dog' ? '🐕' : vaccine.animalType === 'Cat' ? '🐈' : '🐾'} {vaccine.animalType}
//                     </span>
//                   )}
//                   {vaccine.exposureCategory && vaccine.exposureCategory !== 'N/A' && (
//                     <span style={{
//                       fontSize: '0.68rem', fontWeight: 600, padding: '2px 8px',
//                       borderRadius: 20,
//                       background: vaccine.exposureCategory === 'Category III' ? '#fee2e2'
//                         : vaccine.exposureCategory === 'Category II' ? '#fff7ed' : '#dcfce7',
//                       color: vaccine.exposureCategory === 'Category III' ? '#dc2626'
//                         : vaccine.exposureCategory === 'Category II' ? '#c2410c' : '#16a34a',
//                     }}>
//                       ⚠️ {vaccine.exposureCategory}
//                     </span>
//                   )}
//                 </div>
//               </div>
  ...
  return (
    <Container className="py-5 px-5">
      ...
      <DeleteConfirmModal
        ...
        vaccineName={vaccineToDelete?.vaccineName || ''}
          ...
          {visibleVaccines.map(vaccine => (
            ...
            >
              ...
              <div className="d-flex gap-2">
                ...
                <button onClick={() => onDelete(vaccine)} title="Delete vaccine"
                  style={{ background: 'none', border: '2px solid #dc3545', borderRadius: '50%', width: 32, height: 32, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dc3545" strokeWidth="2">
                    <path d="M4 7h16M10 11v6M14 11v6M5 7l1 14h12l1-14H5zM9 3h6v4H9z" />
                  </svg>
...
function DeleteConfirmModal({ show, onClose, onConfirm, vaccineName, isDeleting = false }: DeleteConfirmModalProps) {
  if (!show) return null
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '20px' }}>
          <div style={{
            ...
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
              <path d="M12 8v4m0 4h.01M4 7h16M5 7l1 14h12l1-14H5zM9 3h6v4H9z" stroke="#dc2626" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        ...
        <p style={{ 
          ...
          Are you sure you want to delete <strong>{vaccineName}</strong>?<br />
