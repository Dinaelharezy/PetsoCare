...
//   loading={loading}
//   onComplete={completeVaccine}   // ← أضف اسم الـ prop
//   onAdd={() => setShowModal(true)}
//       onEdit={handleEditClick}     // ← تعديل
...
//   onAdd:             () => void
//    onEdit: (vaccine: Vaccine) => void;    // ← تعديل
...
//             {/* زر الإكمال */}
//             <button onClick={() => onComplete(vaccine.id)} className="complete-btn">
//               ✓
//             </button>

//             {/* زر التعديل - قلم */}
//             <button onClick={() => onEdit(vaccine)} className="edit-btn">
//               ✏️
//             </button>

//             {/* زر الحذف - سلة */}
//             <button onClick={() => onDelete(vaccine.id)} className="delete-btn">
//               🗑️
//             </button>
//           </div>
