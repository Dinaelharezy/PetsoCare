...
//         reviews: clinic.reviews.toString(),
//         image: clinic.image || '',
//         location: clinic.location,
//         phone: clinic.phone,
//         email: clinic.email,
//         bio: clinic.bio,
//         experience: clinic.experience?.toString() || '',
//         published: clinic.published !== false
//       })
//     } else {
...
//     try {
//       await clinicsApi.togglePublish(id)
//       await loadVets()
//       setSuccessMessage('Clinic status updated!')
//       setTimeout(() => setSuccessMessage(''), 3000)
//     } catch (error) {
