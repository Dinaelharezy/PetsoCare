...
//   // Load initial appointments from API
//   useEffect(() => {
...
//       .catch(() => {
//         setAppointments([
//           { id: 1, patientName: 'Ahmed Hassan',  clinicName: 'PetCare Port Said',  date: '2026-03-20', time: '10:00 AM', status: 'Pending' },
//           { id: 2, patientName: 'Sara Mohamed',  clinicName: 'Ismailia Vets',      date: '2026-03-20', time: '11:30 AM', status: 'Approved' },
//           { id: 3, patientName: 'Omar Ali',       clinicName: 'PetCare Port Said',  date: '2026-03-21', time: '02:00 PM', status: 'Rejected' },
//           { id: 4, patientName: 'Nour Ibrahim',  clinicName: 'Suez Animal Clinic', date: '2026-03-22', time: '09:00 AM', status: 'Cancelled' },
//         ])
//       })
//       .finally(() => setLoading(false))
//   }, [])

//   // Listen to the same CustomEvent that NotificationsCard fires
//   useEffect(() => {
...
//       // Highlight the new row for 4 seconds then remove highlight
...
//         {loading ? (
//           <div className="aav-empty">Loading...</div>
...
export default function AdminAppointmentsView() {
  ...
  useEffect(() => {
    fetch('/api/dashboard/appointments/clinic/all', { cache: 'no-store' })
      .then(r => r.json())
      .then(setAppointments)
