...
//                 ))
//               : <p className="text-muted text-center py-4">No animal vaccination locations found.</p>
//           ) : (
//             humanLocations.length > 0
//               ? humanLocations.map(loc => (
//                   <LocationCard key={loc.id} loc={loc} type="human" />
//                 ))
//               : <p className="text-muted text-center py-4">No human vaccination locations found.</p>
//           )}
//         </div>
//       )}
...
//           📞 Hotline for booking and inquiries about Family Health Units:{' '}
//           <strong>15344</strong> (General Authority for Healthcare)
//         </div>
//       )}
