...
export default function VaccinationSchedule() {
  ...
  return (
    ...
    />
          {/* Immediate Actions */}
          <div style={{ background: '#fff8e1', border: '1px solid #ffe082', borderRadius: 10, padding: '16px 20px', marginBottom: 20,marginTop:20 }}>
...
<div style={{
  ...
  {/* Header */}
  <div style={{ background: '#2b44c0', padding: '1.5rem 1.75rem 1.25rem' }}>
    <span style={{
      display: 'inline-flex', alignItems: 'center', gap: '5px',
      background: '#e74c3c', color: '#fde8e8',
      fontSize: '11px', fontWeight: 500,
      padding: '3px 10px', borderRadius: '20px', marginBottom: '10px'
    }}>
      <i className="bi bi-shield-plus"></i> Life-saving vaccination
    </span>
    <p style={{ fontSize: '22px', fontWeight: 500, color: '#fff', margin: '0 0 4px' }}>
     Post-Exposure Vaccination (PEP) – For Human
    </p>
    <p style={{ fontSize: '13px', color: '#fefafa', margin: 0 }}>
      For human rabies — rabies vaccine after exposure
    </p>
  </div>
  ...
  <div style={{ padding: '1.25rem 1.75rem' }}>
    ...
    <div style={{
      ...
      background: '#ffffff', border: '0.5px solid #e9e3e3',
      ...
      <div style={{
        ...
        <i className="bi bi-exclamation-lg" style={{ color: '#fcf1f1', fontSize: '17px' }}></i>
      </div>
      <div>
        <strong style={{ display: 'block', fontSize: '14px', color: '#020202', marginBottom: '2px' }}>
          Do not wait for symptoms to appear
        </strong>
        <p style={{ fontSize: '13px', color: '#050505', margin: 0, lineHeight: 1.6 }}>
          If you are bitten or scratched by a suspected animal, Post-exposure vaccination can prevent the disease if taken in time.
        </p>
      </div>
    </div>
...
[6] World Health Organization. (2018). Rabies vaccines: WHO position paper, April 2018 – Recommendations. Vaccine, 36(37), 5500-5503.</span>
                </div>
            ...
            <div style={{ background: '#fff0f0', border: '1px solid #ffc9c9', borderRadius: 8, padding: '12px 16px', marginTop: 12, fontSize: '0.83rem', color: '#555' }}>
              ...
              <ul style={{ marginTop: 6, marginBottom: 6, paddingLeft: 18 }}>
                <li> It is administered once to individuals who have not been previously vaccinated and who have been exposed to an animal suspected of having rabies.</li>
                <li> It is used in exposure cases classified as Category III such as bites to the head, neck, face, hands, and genital area.</li>
                <li> Administration of RIG for wounds classified as Category III is extremely important in wound management.</li>
                 <strong>Timing of RIG Administration : </strong>
                <li>RIG is given once on Day 0 (the day post-exposure prophylaxis, PEP, is initiated), concurrently with the rabies vaccine.
If it is not administered at the start of vaccination on Day 0, it can still be given later up to Day 7 of the post-exposure prophylaxis series.
Method of RIG Administration
It should be infiltrated into and around the wound as much as possible
If part of the dose remains:
It should be administered intramuscularly at a site distant from the rabies vaccine injection site.</li>
...
{tab === 'human' && (
  <div style={{ background: '#fff3cd', border: '1px solid #ffc107', borderRadius: 10, padding: '16px 20px', marginTop: 16, fontSize: '0.83rem' }}>
    <div style={{ fontWeight: 700, marginBottom: 8 }}>📢 Key Updates in the Rabies Prevention Guidelines – August 2025</div>
    ...
    <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
      ...
      <div style={{ flex: 1 }}>
        <ol style={{ paddingLeft: 18, margin: 0, color: '#555' }}>
          <li>Samples collected from a suspected rabies case include saliva and serum. The saliva sample should be collected <strong>three times within a 24-hour period</strong>.</li>
          <li>Mass bite incidents must be reported starting from <strong>three cases or more</strong>.</li>
          <li>Post-exposure prophylaxis (PEP) doses after a bite or scratch from an animal have been updated to <strong>four doses instead of five</strong>, with the same intervals between the four doses: (0, 3, 7, and 14 days).</li>
          <li>Regardless of any delay, if a patient misses any scheduled dose and later presents to the center to continue vaccination (without a new bite), <strong>the remaining doses should be completed</strong>.</li>
          <li>For immunocompromised patients, proof of immunodeficiency should be provided, and a <strong>fifth dose should be administered on Day 28</strong> from the date of the first dose.</li>
          <li>
            <strong>If the biting animal can be observed:</strong>
            <ul style={{ marginTop: 4, marginBottom: 4 }}>
              <li><em>If the patient presents immediately after the bite or scratch:</em> The first dose should be administered, and the patient should be instructed to observe the animal for 10 days from the date of exposure. If no behavioral changes occur in the animal during the observation period, the vaccination process should be discontinued at the end of the tenth day of the observation.</li>
              <li><em>If the patient presents after 10 days from the date of exposure:</em> The patient should be asked whether any behavioral changes occurred in the animal during the observation period. If no behavioral changes are reported, the vaccine should not be administered.</li>
            </ul>
          </li>
          <li>
            <strong>Booster doses:</strong>
            <ul style={{ marginTop: 4, marginBottom: 4 }}>
              <li>In the case of a stray animal, two booster doses should be given: the first on Day 0 and the second on Day 3, if the patient had previously completed the full vaccination course and <strong>at least three months have passed since the fourth dose</strong>.</li>
              <li>Booster doses should be postponed until the 10-day observation period of the biting animal is completed from the date of exposure. If no behavioral changes occur in the animal, vaccination should not be given.</li>
            </ul>
          </li>
          <li>
            <strong>Rabies Immunoglobulin:</strong>
            <ul style={{ marginTop: 4, marginBottom: 4 }}>
              <li>The serum should be administered to eligible cases according to wound assessment, <strong>once within 24 hours</strong>, and no later than 7 days from the date of the first vaccine dose. It should not be administered again, even if the patient experiences a new bite and the wound would otherwise indicate serum administration.</li>
              <li>If it is not possible to infiltrate the serum around the bite or scratch site, the entire dose should be administered intramuscularly in the muscle nearest to the wound site.</li>
              <li>If serum administration coincides with Measles–Rubella vaccination, the vaccination should be postponed for at least <strong>4 months</strong>. If it coincides with Varicella vaccination, the vaccination should be postponed for at least <strong>3 months</strong>, while ensuring that serum administration is given (priority is given to the serum because it is life-saving).</li>
            </ul>
          </li>
          <li>
            <strong>If a patient is exposed to a new bite but had a previous bite for which vaccination was given:</strong>
            <ul style={{ marginTop: 4, marginBottom: 4 }}>
              <li>Received 4 doses &amp; returned <em>before</em> 3 months since 4th dose: <strong>No vaccination given.</strong></li>
              <li>Received 4 doses &amp; returned <em>after</em> 3 months since 4th dose: <strong>Administer booster doses.</strong></li>
              <li>Received 3 doses &amp; returned before 3 months since 3rd dose: <strong>Administer the 4th dose</strong> (completion of the schedule).</li>
              <li>Received 3 doses &amp; returned after 3 months since 3rd dose: <strong>Administer booster doses.</strong></li>
              <li>Received 1 or 2 doses in the first incident and returned to the center: <strong>Complete the remaining doses.</strong></li>
            </ul>
          </li>
        </ol>

        <div style={{ marginTop: 10, fontSize: '0.78rem', color: '#888' }}>
          Source: [12] Ministry of Health and Population. Preventive Medicine and Public Health Sector. Central Administration of Public Health. General Directorate for Infectious Disease Control. Arab Republic of Egypt, 2025. Key updates in the rabies prevention guidelines – August 2025.
          <br />
          <a href="https://media.gemini.media/img/original/2025/8/11/2025_8_11_12_56_11_63.webp" target="_blank" rel="noopener noreferrer" style={{ color: '#0d6efd', wordBreak: 'break-all' }}>
            https://media.gemini.media/img/original/2025/8/11/2025_8_11_12_56_11_63.webp
          </a>
      ...
      <div style={{ flexShrink: 0 }}>
        ...
        />
        <p style={{ textAlign: 'center', fontSize: '0.7rem', color: '#aaa', marginTop: 4 }}>
          click to expand
        </p>
      </div>
